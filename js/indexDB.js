...
const getData = async () => {
    try {
        const result = await fetch("http://ec2-3-16-68-68.us-east-2.compute.amazonaws.com/routes/datoRoute.php");
...
const deleteData = async (codigo) => {
    try {
        const result = await fetch(`http://ec2-3-16-68-68.us-east-2.compute.amazonaws.com/routes/datoRoute.php?codigo=${codigo}`, {
			method: 'DELETE',
			headers: {
				'Content-Type': 'application/json'
			}
